...
export function ComparisonTable() {
  return (
    <section id="comparison" className="py-[100px] relative z-10 bg-[var(--bg-alt)] border-y border-[var(--line-soft)]">
      <div className="max-w-[1180px] mx-auto px-8">
        ...
        <Reveal className="border border-[var(--line)] rounded-[6px] overflow-hidden bg-[var(--surface)]">
